...
<template>
	...
	>
		...
		>
			...
			<li>
				<a class="text-sm font-bold" href="#">{{ $t('services') }}</a>
			</li>
			<li class="text-gray-299">
				<svg
					fill="none"
			...
			<li>
				<a
					class="text-sm text-gray-399 hover:text-gray-500 text-nowrap"
					href="#"
					>{{ $t('aboutUs') }}</a
				>
			</li>
		...
		<a
			class="inline-block ml-auto mr-2 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 dark:bg-gray-700 dark:text-red-700 font-bold rounded-xl transition duration-200"
			href="#"
			>{{ $t('contact') }}</a
		>
		<a
