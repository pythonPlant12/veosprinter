...
const navbarCloseButton: HTMLElement = ref('navbarCloseButton')
const navbarMenu: HTMLElement = ref('navbarMenu')
const navbarBackdrop: HTMLElement = ref('navbarBackdrop')
...
<template>
	<div
		class="relative px-4 py-4 flex justify-between items-center bg-background z-50"
	>
		...
		<div>
			<button
				ref="navbarBurgerButton"
				@click="toggleNavBar()"
				class="navbar-burger flex items-center text-red-800 p-3"
			>
				<svg
	...
	<div ref="navbarMenu" class="relative z-50 hidden">
		...
		>
			<div class="flex items-center mb-8">
				...
				<button ref="navbarCloseButton" @click="toggleNavBar">
					<svg
			...
			<div>
				<ul>
					<li class="mb-1">
						<a
							class="block p-4 text-sm font-semibold text-gray-400 hover:bg-gray-100 hover:text-red-800 rounded hover:dark:bg-gray-800"
							href="#"
							>{{ $t('home') }}</a
						>
					</li>
			...
			<div class="mt-auto">
				<div class="pt-6">
					<a
						class="block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 rounded-xl text-primary"
						href="#"
						>{{ $t('contact') }}</a
					>
					<a
